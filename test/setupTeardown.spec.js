...
describe('quem sobreviveu?', () => {
  beforeEach (() => {
    ...
    if(adventure.specialists.length > 1) return console.log(adventure.specialists);
  });

  afterAll(() => {
    console.log(`My dear ${Object.values(adventure.specialists[0])[0]} has no princess to rescue here...`);
  });
