...
describe('quem sobreviveu?', () => {
  beforeEach(() => {
    adventure.randomAttack();// antes de cada test chama a função randomAttack();
  });

  afterEach(() => {
    console.log('Aventureiros Restantes: ', adventure.specialists.map(e => e.nome));// Nome dos aventureiros restantes
  });
