...
describe('verifica o usuário', () => {
  ...
  test('verifica se o usuário é o tunico', async () => {
    ...
    api.fetchURL = jest.fn().mockResolvedValue({gender: 'male', name: {first: 'Antônio', last: 'Britto'}, location: {country: 'Brazil'}, email: 'tunico@bol.com.br', login: {username: 'tunicao123', password: '1234567890'}});
