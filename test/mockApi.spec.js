...
jest.mock('../src/mockApi') // mockando tudo do arquivo assim conseguimos 
// api.fetchURL.mockResolvedValue(tunicao); em vez de
// const api.fetchURL = jest.jn().mockresolvedvalue(tunicao);
